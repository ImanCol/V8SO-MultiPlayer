...
public class PlayerManager : MonoBehaviour
{
    ...
    public uint trailerWheelAddr1;

    public uint trailerWheelAddr2;

    public uint cameraAddr;
    ...
    public uint Address
    {
        ...
        {
#if DEBUG
            Debug.Log("GetPass: SetAddress: 0x" + address.ToString("X"));
#endif
            return address;
        }
        set
        {
            address = value;
#if DEBUG
            Debug.Log("SetPass: SetAddress: 0x" + address.ToString("X"));
#endif
