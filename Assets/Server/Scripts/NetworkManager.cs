...
int serverPort;
    ...
    public void Start()
    {
        if (UIManager.instance.serverPORTField.text == "")
            UIManager.instance.serverPORTField.text = "26950";
        serverPort = int.Parse(UIManager.instance.serverPORTField.text);
        QualitySettings.vSyncCount = 0;
        Application.targetFrameRate = 30;
        Server.Start(5, serverPort);
    }
